...
import 'react-toastify/dist/ReactToastify.css';
import './SysForm.css';
import './SysProducts.css';  // Add this line to import the new CSS file
  ...
  return (
    <div className="main-container">
      ...
      <div className={`content ${isSidebarOpen ? 'container-shifted' : ''}`} style={{ padding: '20px', display: 'flex' }}>
        ...
        <div style={{ flex: '2' }}>
          <center><h1>Products</h1></center>
          <table className="table table-bordered table-hover custom-table" style={{ width: '90%' }}>
            <thead className="thead-dark">
              <tr>
                <th scope="col" style={{ width: '50px', backgroundColor:'grey', color:'white' }}>Product ID</th>
                <th scope="col" style={{ width: '200px' , backgroundColor:'grey', color:'white'}}>Name</th>
                <th scope="col" style={{ width: '120px', backgroundColor:'grey', color:'white' }}>Stock Level</th>
                <th scope="col" style={{ width: '120px', backgroundColor:'grey', color:'white' }}>Price</th>
                <th scope="col" style={{ width: '120px', backgroundColor:'grey', color:'white' }}>
                  Action
                </th>
              </tr>
            </thead>
            <tbody>
              {products.map((product,index) => (
                <tr key={product.productID} style={{ backgroundColor: index % 2 === 0 ? '#e6f2ff' : '#ffffff' }}>
                  <td style={{ backgroundColor: index % 2 === 0 ? '#e6f2ff' : '#ffffff' }}>{product.productID}</td>
                  <td style={{ backgroundColor: index % 2 === 0 ? '#e6f2ff' : '#ffffff' }}>{product.name}</td>
                  <td style={{ backgroundColor: index % 2 === 0 ? '#e6f2ff' : '#ffffff' }}>{product.stockLevel}</td>
                  <td style={{ backgroundColor: index % 2 === 0 ? '#e6f2ff' : '#ffffff' }}>{product.price}</td>
                  <td style={{width:'200px',backgroundColor: index % 2 === 0 ? '#e6f2ff' : '#ffffff' }}>
                    <button
                      className="btn btn-info btn-sm mr-2"
                      onClick={() => handleUpdate(product)}
                    >
